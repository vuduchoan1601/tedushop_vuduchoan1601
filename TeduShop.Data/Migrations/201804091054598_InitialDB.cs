namespace TeduShop.Data.Migrations
{
    ...
    public partial class InitialDB : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        TagID = c.String(nullable: false, maxLength: 10, unicode: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.OrderDetals", "ProductID", "dbo.Products");
            DropForeignKey("dbo.Products", "CategoryID", "dbo.ProductCategories");
            DropForeignKey("dbo.OrderDetals", "OrderID", "dbo.Orders");
            DropForeignKey("dbo.Menus", "GroupID", "dbo.MenuGroups");
            DropIndex("dbo.Posts", new[] { "CategoryID" });
            DropIndex("dbo.Products", new[] { "CategoryID" });
            DropIndex("dbo.OrderDetals", new[] { "ProductID" });
            DropIndex("dbo.OrderDetals", new[] { "OrderID" });
